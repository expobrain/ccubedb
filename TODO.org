...
* TODO [9/17] Prepare for test launch (the project works in background)
...
** TODO no need to use a lot of return codes apart from "quit"
** TODO  a list of clients should be a mapping
** TODO append for slist

** TODO [2/5] backend DSs
...
** TODO sanitize=asan
** TODO sanitize=ubsan
** TODO deploy in a container

   - [ ] build scripts in the repo

   - [ ] deploy to an actual machine

   - [ ] start loading data

   - [ ] visualising data using the CLI client

* TODO [0/2] Full launch
** TODO dumping and reloading
